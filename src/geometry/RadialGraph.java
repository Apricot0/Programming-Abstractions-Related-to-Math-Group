...
public class RadialGraph extends Shape {
    ...
    /**
     * Construct a Radial Graph using a center point and neighbor points, the neighbor points will be sort using the same rule in toString (all other points of this shape are included in increasing order of their angle with respect to the positive x axis (0 to 360 (not included) degrees)).
     *
